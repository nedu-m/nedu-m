...
function initCursor() {
    try {
        require("5b7ebda175e98c7f").then(({ Cursor })=>{
            const cursors = document.querySelectorAll('.cursor');
            if (cursors.length > 0) new Cursor(cursors, 'a, .project__toggle');
        }).catch(()=>{
...
},{"5b7ebda175e98c7f":"85GPW"}],"85GPW":[function(require,module,exports,__globalThis) {
module.exports = import("./cursor.e89a9d41.js").then(()=>module.bundle.root('czxmt'));

},{"czxmt":"czxmt"}]},["6DHTQ","6kb64"], "6kb64", "parcelRequire2f84", {})

//# sourceMappingURL=cranky-lamport.6528c13b.js.map
